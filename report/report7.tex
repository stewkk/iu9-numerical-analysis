...
\begin{titlepage}
	...
	\begin{center}
		\textbf{ОТЧЕТ} \\\textit{по лабораторной работе № 1\\по курсу <<Численные методы линейной алгебры>>\\Вариант № 26} \\
	\end{center}
	...
	\raisebox{0.35ex}{\underline{\parbox{4cm}{\centering Посевин Д.П.}}}
...
\item Реализовать вывод трёхмерного графика
\end{enumerate}
...
\captionof{listing}{Исходный код программы на Julia}
\vspace{0.5cm}
  \begin{minted}[style=bw, breaklines, frame=single, fontsize = \footnotesize, linenos=false, xleftmargin = 1.5em]{julia}
using PyCall
pygui(:tk)
using PyPlot
using LinearAlgebra
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{./lab8.png}
  \end{minipage}
  \caption{Результат}
  \label{fig:graphs}
\end{figure}
